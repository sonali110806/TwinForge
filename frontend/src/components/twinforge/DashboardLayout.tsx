...
export default function DashboardLayout() {
  const [agentStatus, setAgentStatus] = useState<"monitoring" | "thinking" | "executing">("monitoring");
  const [systemStatus, setSystemStatus] = useState<"healthy" | "critical" | "warning">("healthy");
    ...
    <div className="min-h-screen bg-background text-foreground flex">
      ...
      <main className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <div className="flex-1 p-4 md:p-6 overflow-auto">
          <Outlet context={{ ws, systemStatus, setSystemStatus, agentStatus, setAgentStatus }} />
        </div>
      </main>
    </div>
  );
